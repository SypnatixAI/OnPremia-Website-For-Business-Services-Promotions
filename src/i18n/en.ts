...
export const en: Dictionary = {
  ...
  services: {
    ...
    items: [
      {
        eyebrow: 'Search',
        title: 'Find a document in seconds',
        gain: 'Your team stops digging.',
      },
      {
        eyebrow: 'Automation',
        title: 'Email that sorts itself',
        gain: 'Nothing falls through the cracks.',
      },
      {
        eyebrow: 'Drafting',
        title: 'Replies ready to send',
        gain: 'You review instead of writing.',
      },
      {
        eyebrow: 'Control',
        title: 'One place to govern it all',
        gain: 'You know who uses what, and what it costs.',
      },
