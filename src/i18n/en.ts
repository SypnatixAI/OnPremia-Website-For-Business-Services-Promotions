...
export const en: Dictionary = {
  ...
  calculator: {
    eyebrow: 'Estimate',
    title: 'How much your business could get back.',
    lead: 'Enter your numbers. The estimate adjusts to your reality.',
    inputsTitle: 'Your numbers',
    inputsHint: 'Your business as it runs today, before any automation.',
    emailsLabel: 'Emails handled per week in your business',
    adminLabel: 'Admin hours per week on your team',
    rateLabel: 'Average hourly cost of your employees (loaded salary)',
    rateNote: 'What one hour of work costs in your business',
    resultsTitle: 'What your business gets back',
    weeklyLabel: 'Hours your team gets back, per week',
    yearlyLabel: 'Per year',
    valueLabel: 'Annual value to your business',
    hoursUnit: 'h',
